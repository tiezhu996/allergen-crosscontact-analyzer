...
type AssessmentRun struct {
	...
	AssessmentStatus  constants.AssessmentStatus `gorm:"size:32;index;not null;check:assessment_status IN ('queued','calculating','pending_review','accepted','rejected')" json:"assessment_status"`
	...
	HighestRiskLevel  constants.RiskLevel        `gorm:"size:16;not null" json:"highest_risk_level"`
